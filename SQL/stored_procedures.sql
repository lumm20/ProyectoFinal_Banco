...
delimiter $$
create procedure sp_consultarTransferenciasPorNumCuenta(in numCuenta varchar(10))
begin
...
#declarando manejador de excepciones
    ...
    insert into transacciones (num_cuenta, fecha_hora, monto, tipo_transaccion)
    values (numCuentaDestino, fechaHora, monto, "transferencia");
    #guarda el id auto-generado de la transaccion
