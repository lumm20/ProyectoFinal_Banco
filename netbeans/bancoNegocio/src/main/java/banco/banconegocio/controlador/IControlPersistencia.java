...
public interface IControlPersistencia {
     ...
     * @throws PersistenciaException en caso de que no haya clientes registrados
     * o en caso de que ocurra un error de base de datos al realizar la consulta
     */
     ...
     * @throws PersistenciaException en caso de que ocurra un error de base de
     * datos al agregar al cliente
     */
    ...
    /**
     * Actualiza la informacion personal de un cliente, a excepcion de su id de
     * cliente
     *
     * @param cliente con la informacion a actualizar
     * @throws PersistenciaException en caso de que ocurra un error de base de
     * datos al actualizar al cliente
     */
    public void actualizarCliente(Cliente cliente) throws PersistenciaException;

    /**
     * Realiza una consulta de una cuenta con el num_cuenta especificado en el
     * parametro
     *
     ...
     * @throws PersistenciaException en caso de que no haya cuentas registradas
     * o en caso de que ocurra un error de base de datos al realizar la consulta
     */
